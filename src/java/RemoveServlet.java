...
public class RemoveServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            String learner = request.getParameter("bt1");
            String trainer = request.getParameter("bt2");
           ...
           try
           {
              ...
              if(trainer!=null)
               {
                   PreparedStatement ps1 = con.prepareStatement("delete from trainers where EMAIL=?");
