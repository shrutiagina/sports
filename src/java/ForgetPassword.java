    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try
            {
                ...
                PreparedStatement ps = con.prepareStatement("select * from learners where EMAIL = ?");
                ...
                if(password.equals(current))
                {
                    ...
                    {
                         PreparedStatement ps1 = con.prepareStatement("update learners set SR_PASSWORD = ? where EMAIL = ?  ");
                    ...
                    {
                          out.println("new password and current password are not same ");
                    }
                }
                else
                {
