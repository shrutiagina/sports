 ...
 */
public class football_register extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
           ...
           String pass = (String)session.getAttribute("pass");
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet football_register</title>");            
            out.println("</head>");
            out.println("<body>");
              ...
              try
            {
               ...
               while(rs.next())
               {
                   ...
                   out.println("<html><body><script>alert('Date and Time has already fixed by other user!!!');window.location.assign('football_register.html');</script></body></html>");
                        
                     }
                     else
                     {
                  
                         PreparedStatement ps1 =con.prepareStatement("insert into football values(?,?,?,?,?,?,?,?,?,?,?)");
