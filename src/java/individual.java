           ...
           String  swimming = request.getParameter("swimming");
            ...
            try
            {
                ...
                Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/sports","root","");
                 if(cricket!=null)
               {
                 PreparedStatement ps = con.prepareStatement("select * from cricket where USER_CATEGORY='Individual'");
                ...
                while(rs.next())
                {
                 ...
                 /*football*/
                    ...
                    if(football!=null)
               {
                 PreparedStatement ps = con.prepareStatement("select * from football where USER_CATEGORY='Individual'");
                ResultSet rs = ps.executeQuery();
                out.println("<center>");
                out.println("<h1>STUDENT DETAILS <h1>");
                ...
                while(rs.next())
                {
                 ...
                 out.println("</table>");
                    ...
                    /*basketball*/
                       ...
                       if(basketball!=null)
               {
                 PreparedStatement ps = con.prepareStatement("select * from basketball where USER_CATEGORY='Individual'");
                ResultSet rs = ps.executeQuery();
                out.println("<center>");
                out.println("<h1>STUDENT DETAILS <h1>");
                ...
                while(rs.next())
                {
                 ...
                 out.println("</table>");
                       ...
                       /*volleyball*/
                          ...
                          if(volleyball!=null)
               {
                 PreparedStatement ps = con.prepareStatement("select * from volleyball where USER_CATEGORY='Individual'");
                ResultSet rs = ps.executeQuery();
                out.println("<center>");
                out.println("<h1>STUDENT DETAILS <h1>");
                ...
                while(rs.next())
                {
                 ...
                 out.println("</table>");
                          ...
                          /*swimming*/
                             ...
                             if(swimming!=null)
               {
                 PreparedStatement ps = con.prepareStatement("select * from swimming where USER_CATEGORY='Individual'");
                ResultSet rs = ps.executeQuery();
                out.println("<center>");
                out.println("<h1>STUDENT DETAILS <h1>");
                ...
                while(rs.next())
                {
                 ...
                 out.println("</table>");
                             ...
                             /*badminton*/
                                ...
                                if(badminton!=null)
               {
                 PreparedStatement ps = con.prepareStatement("select * from badminton where USER_CATEGORY='Individual'");
                ResultSet rs = ps.executeQuery();
                out.println("<center>");
                out.println("<h1>STUDENT DETAILS <h1>");
