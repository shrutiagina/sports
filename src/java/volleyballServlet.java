...
"  text-align:center;\n" +
"}    </style>");
            out.println("<title>Servlet volleyballServlet</title>");            
            out.println("</head>");
            out.println("<body>");
              ...
              try
            {
               ...
               out.println("<br><br>");
               out.println("<h1 align='center' style='color:#088A85'>VOLLEYBALL</h1>");
                out.println("<br><br>");
               ...
               mail = MyGlobals.mail ;
                ...
                out.println("<span style = 'padding-left:10%'><img src='volleyball4.jfif' width='80%' height='10%'><div class='bg-text'><h1 style='font-size:38px;font-family:Cambria Math;color:white;'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Believe in your volleyball "+"<br>"+"&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;dreams and your are"+"<br>"+"Halfway to your"+"<br>"+" volleyball goals...</h1></div>");
