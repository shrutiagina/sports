...
"}"+
                          " </style>");
            out.println("<title>Servlet badmintonServlet</title>");            
            out.println("</head>");
            out.println("<body>");
           try
            {
               ...
               out.println("<br><br>");
               out.println("<h1 align='center' style='color:#088A85'>BADMINTON</h1>");
                out.println("<br><br>");
               ...
               mail = MyGlobals.mail ;
                ...
                out.println("<span style = 'padding-left:5%'><img src='bminton.jpg' width='90%' height='10%'><div class='bg-text'><h1 style='font-size:35px;font-family:Cambria Math;color:white;'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Set your Badminton "+"<br>"+"Goals high and"+"<br>"+"don't stop till"+"<br>"+" you get there...</h1></div>");
...
"             </select>"
                        ...
                        +"<input type='reset' class='button' value='reset'>"+"<br><br><br>"
                +"</form>");
