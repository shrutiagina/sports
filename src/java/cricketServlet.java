           ...
           try
            {
               ...
               out.println("<br><br>");
               out.println("<h1 align='center' style='color:#088A85'>CRICKET</h1>");
                out.println("<br><br>");
               ...
               mail = MyGlobals.mail ;
                ...
                out.println("<span style = 'padding-left:13%'><img src='cricket.jpg' width='80%' height='10%'>");
                
                out.println("<br><br>"+"<h2 style='color:#B18904;font-family:Cambria Math;padding-left:13%'>Believe in giving more than 100 % on the field and dont worry about the result,"+"<br>"+"if there is a great commitment on the field that is your victory</h2>"  +" <br><br>");
