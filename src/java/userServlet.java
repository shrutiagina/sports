    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try
            {
               ...
               while(rs.next())
               {
                     if(email.equals(rs.getString(6))&&password.equals(rs.getString(9)))
                     {
...
"                    </script>\n");
              ...
              else if(name.equalsIgnoreCase("trainer"))
               {
                   ...
                   while(rs.next())
                   {
                       ...
                       {
                           MyGlobals.mail = email;
                           request.getRequestDispatcher("trainerlogin").forward(request, response);
                       }
                       else
                       {
                         out.println("<script type=\"text/javascript\">\n" +
...
"                    </script>\n");
              ...
              {
                if(email.equals("admin123@gmail.com")&&password.equals("admin01"))
                {
